...
for broad_type in BROAD_TYPES:
    ...
    # Build AnnData on the raw feature matrix
    ...
    # 2) one‐hot encode Region (drop first to avoid collinearity)
    ...
    # 3) run ComBat, preserving Region differences
    sc.pp.combat(
        adata,
        key='batch',
    ...
    # 4) pull out corrected data and re‐scale for PCA/UMAP
